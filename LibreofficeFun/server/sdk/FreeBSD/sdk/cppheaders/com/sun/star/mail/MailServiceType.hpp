...
SAL_DEPRECATED("use cppu::UnoType") inline ::css::uno::Type const & SAL_CALL getCppuType(SAL_UNUSED_PARAMETER ::css::mail::MailServiceType const *) {
    return ::cppu::UnoType< ::css::mail::MailServiceType >::get();
}
