...
inline Currency::Currency(const ::sal_Int64& Value_)
    : Value(Value_)
{
}
...
SAL_DEPRECATED("use cppu::UnoType") inline ::css::uno::Type const & SAL_CALL getCppuType(SAL_UNUSED_PARAMETER ::css::bridge::oleautomation::Currency const *) {
