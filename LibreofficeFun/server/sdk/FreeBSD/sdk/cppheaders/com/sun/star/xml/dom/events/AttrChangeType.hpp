...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::xml::dom::events::AttrChangeType const *) {
    static typelib_TypeDescriptionReference * the_type = 0;
    if ( !the_type )
    {
        typelib_static_enum_type_init( &the_type,
                                       "com.sun.star.xml.dom.events.AttrChangeType",
                                       ::css::xml::dom::events::AttrChangeType_MODIFICATION );
    }
...
SAL_DEPRECATED("use cppu::UnoType") inline ::css::uno::Type const & SAL_CALL getCppuType(SAL_UNUSED_PARAMETER ::css::xml::dom::events::AttrChangeType const *) {
    return ::cppu::UnoType< ::css::xml::dom::events::AttrChangeType >::get();
}
