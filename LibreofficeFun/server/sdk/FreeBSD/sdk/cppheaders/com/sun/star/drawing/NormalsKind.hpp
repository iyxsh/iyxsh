...
SAL_DEPRECATED("use cppu::UnoType") inline ::css::uno::Type const & SAL_CALL getCppuType(SAL_UNUSED_PARAMETER ::css::drawing::NormalsKind const *) {
    return ::cppu::UnoType< ::css::drawing::NormalsKind >::get();
}
