...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::chart2::StackingDirection const *) {
    ...
    if ( !the_type )
    {
        typelib_static_enum_type_init( &the_type,
                                       ...
                                       ::css::chart2::StackingDirection_NO_STACKING );
    }
...
SAL_DEPRECATED("use cppu::UnoType") inline ::css::uno::Type const & SAL_CALL getCppuType(SAL_UNUSED_PARAMETER ::css::chart2::StackingDirection const *) {
    return ::cppu::UnoType< ::css::chart2::StackingDirection >::get();
}
