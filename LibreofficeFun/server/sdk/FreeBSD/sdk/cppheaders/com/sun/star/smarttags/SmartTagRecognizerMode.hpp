...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::smarttags::SmartTagRecognizerMode const *) {
    static typelib_TypeDescriptionReference * the_type = 0;
    if ( !the_type )
    {
        typelib_static_enum_type_init( &the_type,
                                       "com.sun.star.smarttags.SmartTagRecognizerMode",
                                       ::css::smarttags::SmartTagRecognizerMode_CHAR );
    }
...
SAL_DEPRECATED("use cppu::UnoType") inline ::css::uno::Type const & SAL_CALL getCppuType(SAL_UNUSED_PARAMETER ::css::smarttags::SmartTagRecognizerMode const *) {
    return ::cppu::UnoType< ::css::smarttags::SmartTagRecognizerMode >::get();
}
