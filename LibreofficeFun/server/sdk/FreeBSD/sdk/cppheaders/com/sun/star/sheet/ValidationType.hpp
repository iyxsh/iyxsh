...
SAL_DEPRECATED("use cppu::UnoType") inline ::css::uno::Type const & SAL_CALL getCppuType(SAL_UNUSED_PARAMETER ::css::sheet::ValidationType const *) {
    return ::cppu::UnoType< ::css::sheet::ValidationType >::get();
}
