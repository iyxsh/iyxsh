...
SAL_DEPRECATED("use cppu::UnoType") inline ::css::uno::Type const & SAL_CALL getCppuType(SAL_UNUSED_PARAMETER ::css::awt::WindowClass const *) {
    return ::cppu::UnoType< ::css::awt::WindowClass >::get();
}
