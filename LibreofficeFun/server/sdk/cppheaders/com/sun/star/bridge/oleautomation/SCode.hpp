...
inline SCode::SCode(const ::sal_Int32& Value_)
    : Value(Value_)
{
}


inline bool operator==(const SCode& the_lhs, const SCode& the_rhs)
{
...
SAL_DEPRECATED("use cppu::UnoType") inline ::css::uno::Type const & SAL_CALL getCppuType(SAL_UNUSED_PARAMETER ::css::bridge::oleautomation::SCode const *) {
    return ::cppu::UnoType< ::css::bridge::oleautomation::SCode >::get();
}
