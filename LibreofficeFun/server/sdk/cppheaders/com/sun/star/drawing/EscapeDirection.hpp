...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::drawing::EscapeDirection const *) {
    ...
    if ( !the_type )
    {
        typelib_static_enum_type_init( &the_type,
                                       ...
                                       ::css::drawing::EscapeDirection_SMART );
    }
...
SAL_DEPRECATED("use cppu::UnoType") inline ::css::uno::Type const & SAL_CALL getCppuType(SAL_UNUSED_PARAMETER ::css::drawing::EscapeDirection const *) {
    return ::cppu::UnoType< ::css::drawing::EscapeDirection >::get();
}
