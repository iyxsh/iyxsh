...
SAL_DEPRECATED("use cppu::UnoType") inline ::css::uno::Type const & SAL_CALL getCppuType(SAL_UNUSED_PARAMETER ::css::drawing::ShadeMode const *) {
    return ::cppu::UnoType< ::css::drawing::ShadeMode >::get();
}
