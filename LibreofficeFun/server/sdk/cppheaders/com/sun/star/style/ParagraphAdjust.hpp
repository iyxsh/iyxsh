...
SAL_DEPRECATED("use cppu::UnoType") inline ::css::uno::Type const & SAL_CALL getCppuType(SAL_UNUSED_PARAMETER ::css::style::ParagraphAdjust const *) {
    return ::cppu::UnoType< ::css::style::ParagraphAdjust >::get();
}
